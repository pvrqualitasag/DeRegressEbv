...
__Tier $i$__:
Für Tier $i$ ist die Varianz des geschätzten Zuchtwertes $var(\hat{g}_i) = \mathbf{G}_{11} - \mathbf{C}_{11}\sigma_e^2 = \sigma_g^2 - c^{ii}\sigma_e^2$. Das Bestimmtheitsmass ist dann 
